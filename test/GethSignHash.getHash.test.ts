...
describe("GethSignHash.getHash", () => {
  ...
  it("should get message hash for 000", async () => {
    ...
    const has = await tcn.connect(sig[4]).getHash000(7);
  ...
  it("should get message hash for 001", async () => {
    ...
    const has = await tcn.connect(sig[4]).getHash001("0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65");
  ...
  it("should get message hash for 002", async () => {
    ...
    const has = await tcn.connect(sig[4]).getHash002(7, 1);
  ...
  it("should get message hash for 003", async () => {
    ...
    const has = await tcn.connect(sig[4]).getHash003(7, 1, "0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65");
  ...
  it("should get message hash for 004", async () => {
    ...
    const has = await tcn.connect(sig[4]).getHash004(7, 1, "0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65", 700);
  ...
  it("should get message hash for 005", async () => {
    ...
    const has = await tcn.connect(sig[4]).getHash005(7, 1, "0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65", 700);
